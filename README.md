...
<html lang="sp">
<head>
    <title>Reemplazo y ExtracciÃ³n de partes de archivo hexadecimal</title>
    <style>
        body {
...
<body>
    <header>
        <h1 id="pageTitle">gamemodifier/Tool V 3.0</h1>
    </header>
    <main>
    ...
    if (response.ok) {
        ...
        // Muestra la imagen asociada a la ubicaciÃ³n seleccionada
                        ...
                        replacementReader.onload = function(replacementEvent) {
                            ...
                            if (start >= 0 && end <= originalContent.length) {
                                if (replacementContent.length === end - start + 1) {
                                    ...
                                    alert('Contenido reemplazado. Puedes realizar mÃ¡s reemplazos antes de la descarga.');
                                } else {
                                    alert("El archivo para reemplazar no tiene el mismo tamaÃ±o que la ubicaciÃ³n de inicio y fin.");
                                }
                            }
                        };
